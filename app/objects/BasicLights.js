...
export default class BasicLights extends Group {
  constructor(...args) {
    ...
    var song_rgb = {r: Math.round(flowersAudioFeatures.acousticness * 255),
  ...
  update (timeStamp) {
    ...
    if (second > this.state.segments[this.state.segmentIndex].start && this.state.segmentIndex < this.state.segments.length) {
